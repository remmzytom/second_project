...
<!-- Mirrored from radixtouch.com/templates/admin/redstar/source/dark/add_payment.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Dec 2021 23:28:24 GMT -->
<head>
	<meta charset="utf-8" />
 ...
 ?>
					...
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								<li><i class="fa fa- "></i>&nbsp;<a class="parent-item"
									...
									<form class="form-horizontal">
										<div class="form-body">
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="paymentno" data-required="1"
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="patientname" data-required="1"
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input name="number" type="text" placeholder="total amount"
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input name="number" type="text" placeholder="discount"
														class="form-control input-height" /> </div>
											</div>
											<div class="form-group row">
		...
		<div class="page-footer">
			<div class="page-footer-inner"> 2021 &copy; RedStar Hospital Template By
				<a href="https://radixtouch.com/cdn-cgi/l/email-protection#9ae8fffee9eefbe8eef2fff7ffdafdf7fbf3f6b4f9f5f7" target="_top" class="makerCss">Redstartheme</a>
			</div>

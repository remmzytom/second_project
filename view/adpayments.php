...
<!-- Mirrored from radixtouch.com/templates/admin/redstar/source/dark/payments.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Dec 2021 23:28:24 GMT -->
<head>
	<meta charset="utf-8" />
 ...
 ?>
				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Hospital Payments</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
										href="index.html">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li><a class="parent-item" href="#">Payments</a>&nbsp;
								</li>
							</ol>
						</div>
					</div>
										...
										<table class="table table-hover table-checkable order-column full-width"
											...
											<tbody>
												<tr class="odd gradeX">
													...
													<td class="center">DR. John Deo</td>
												...
												<tr class="odd gradeX">
													...
													<td class="center">Jenish Shah</td>
													<td class="center">DR. Megha Trivedi</td>
													<td class="center">12 Jan 2012</td>
													<td class="center">510$</td>
													<td class="center">10%</td>
													<td class="center">5$</td>
		...
		<div class="page-footer">
			<div class="page-footer-inner"> 2021 &copy; RedStar Hospital Template By
				<a href="https://radixtouch.com/cdn-cgi/l/email-protection#5a283f3e292e3b282e323f373f1a3d373b333674393537" target="_top" class="makerCss">Redstartheme</a>
			</div>

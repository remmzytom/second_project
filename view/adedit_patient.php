...
<!-- Mirrored from radixtouch.com/templates/admin/redstar/source/dark/edit_patient.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Dec 2021 23:28:23 GMT -->
<head>
	<meta charset="utf-8" />
	...
	<link href="adminassets/bundles/flatpicker/css/flatpickr.min.css" rel="stylesheet">
...
include "includes/sidebar.php";
									...
									<form action="#" id="form_sample_1" class="form-horizontal">
										<div class="form-body">
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="firstname" data-required="1"
														placeholder="enter first name" value="Ricky"
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="lastname" data-required="1"
														placeholder="enter last name" value="Tailer"
														class="form-control input-height" />
												</div>
											</div>
											<div class="form-group row">
													...
													<div class="input-append date">
														<div id="dateIcon2" class="input-group datePicker">
															<input class="formDatePicker form-control" type="text"
																placeholder="Select Date.." value="05/08/1987"
																data-input>
															<span class="dateBtn">
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="designation" data-required="1"
														placeholder="enter your age" value="30"
														class="form-control input-height" />
												</div>
											</div>
											<div class="form-group row">
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<textarea name="address" placeholder="address"
														...
														rows="5">A-101, Sun Velly, Paris</textarea>
												</div>
											</div>
											<div class="form-group row">
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" class="form-control input-height"
														placeholder="blood presure" name="bp" value="102">
												</div>
											</div>
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" class="form-control input-height"
														placeholder="sugger" name="sug" value="89">
												</div>
											</div>
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" class="form-control input-height"
														placeholder="injury/condition" name="injury" value="fever">
												</div>
											</div>
		...
		<div class="page-footer">
			<div class="page-footer-inner"> 2021 &copy; RedStar Hospital Template By
				<a href="https://radixtouch.com/cdn-cgi/l/email-protection#93e1f6f7e0e7f2e1e7fbf6fef6d3f4fef2faffbdf0fcfe" target="_top" class="makerCss">Redstartheme</a>
			</div>
	...
	<script src="adminassets/bundles/jquery-validation/js/jquery.validate.min.js"></script>
	<script src="adminassets/bundles/jquery-validation/js/additional-methods.min.js"></script>
	<!-- bootstrap -->
	...
	<script src="adminassets/data/form-validation.js"></script>

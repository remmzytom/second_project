...
<!-- Mirrored from radixtouch.com/templates/admin/redstar/source/dark/add_doctor_material.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Dec 2021 23:28:21 GMT -->
<head>
	<meta charset="utf-8" />
 ...
 ?>
									...
									<div class="col-lg-12 p-t-20">
										<div
											...
											<ul data-mdl-for="list2" class="mdl-menu mdl-menu--bottom-left mdl-js-menu">
												<li class="mdl-menu__item" data-val="DE">Neurology</li>
												<li class="mdl-menu__item" data-val="BY">Orthopedics</li>
												<li class="mdl-menu__item" data-val="BY">Gynaecology</li>
												<li class="mdl-menu__item" data-val="BY">Microbiology</li>
											</ul>
										</div>
									</div>
									<div class="col-lg-12 p-t-20">
		...
		<div class="page-footer">
			<div class="page-footer-inner"> 2021 &copy; RedStar Hospital Template By
				<a href="https://radixtouch.com/cdn-cgi/l/email-protection#e290878691968390968a878f87a2858f838b8ecc818d8f" target="_top" class="makerCss">Redstartheme</a>
			</div>

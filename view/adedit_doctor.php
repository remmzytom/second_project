...
<!-- Mirrored from radixtouch.com/templates/admin/redstar/source/dark/edit_doctor.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Dec 2021 23:28:21 GMT -->
<head>
	<meta charset="utf-8" />
...
include "includes/sidebar.php";
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="firstname" data-required="1"
														placeholder="enter first name" value="Lalit"
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="lastname" data-required="1"
														placeholder="enter last name" value="Joshi"
														class="form-control input-height" />
												</div>
											</div>
											<div class="form-group row">
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="designation" data-required="1"
														placeholder="enter your designation" value="Physician"
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<select class="form-control input-height" name="department">
														...
														<option selected="selected" value="Category 2">Orthopedics
														</option>
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<textarea name="address" placeholder="address"
														...
														rows="5">23, Sagar Appartment, Near Nationl Bank</textarea>
												</div>
											</div>
											<div class="form-group row">
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<textarea name="address" class="form-control-textarea"
														placeholder="Education" rows="5">M.B.B.S, M.S.</textarea>
												</div>
											</div>
										</div>
		...
		<div class="page-footer">
			<div class="page-footer-inner"> 2021 &copy; RedStar Hospital Template By
				<a href="https://radixtouch.com/cdn-cgi/l/email-protection#9be9feffe8effae9eff3fef6fedbfcf6faf2f7b5f8f4f6" target="_top" class="makerCss">Redstartheme</a>
			</div>

...
<!-- Mirrored from radixtouch.com/templates/admin/redstar/source/dark/add_patient_material.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Dec 2021 23:28:23 GMT -->
<head>
	<meta charset="utf-8" />
	...
	<!-- dropzone -->
	<link href="adminassets/bundles/dropzone/dropzone.css" rel="stylesheet" media="screen">
	<!-- Date Time item CSS -->
	<link rel="stylesheet" href="adminassets/bundles/flatpicker/css/flatpickr.min.css" />
	<!-- favicon -->
 ...
 ?>
								...
								<div class="card-body row">
									<div class="col-lg-12 p-t-20">
										<div
											...
											<label class="mdl-textfield__label" for="txtFirstName">First Name</label>
										</div>
									</div>
									<div class="col-lg-12 p-t-20">
										<div
											...
											<label class="mdl-textfield__label" for="txtLasttName">Last Name</label>
										</div>
									</div>
									<div class="col-lg-12 p-t-20">
										<div
									...
									<div class="col-lg-12 p-t-20">
										<div
											...
											<label for="sample3" class="mdl-textfield__label">Marital Status</label>
											<ul data-mdl-for="sample3"
												class="mdl-menu mdl-menu--bottom-left mdl-js-menu">
												<li class="mdl-menu__item" data-val="DE">Single</li>
												<li class="mdl-menu__item" data-val="BY">Married</li>
											</ul>
										</div>
									</div>
									<div class="col-lg-12 p-t-20">
									...
									<div class="col-lg-12 p-t-20">
										<div
											...
											<input class="mdl-textfield__input" type="text" id="sample4" value=""
												readonly tabIndex="-1">
											<label for="sample4" class="pull-right margin-0">
												<i class="mdl-icon-toggle__label material-icons">keyboard_arrow_down</i>
											</label>
											<label for="sample4" class="mdl-textfield__label">Blood Group</label>
											<ul data-mdl-for="sample4"
												class="mdl-menu mdl-menu--bottom-left mdl-js-menu">
												<li class="mdl-menu__item" data-val="ap">A+</li>
												<li class="mdl-menu__item" data-val="am">A-</li>
												<li class="mdl-menu__item" data-val="bp">B+</li>
												<li class="mdl-menu__item" data-val="bm">B-</li>
												<li class="mdl-menu__item" data-val="abp">AB+</li>
												<li class="mdl-menu__item" data-val="abm">AB-</li>
												<li class="mdl-menu__item" data-val="op">O-</li>
												<li class="mdl-menu__item" data-val="om">O-</li>
											</ul>
										</div>
									</div>
									<div class="col-lg-12 p-t-20">
										<div
											...
											<label class="mdl-textfield__label" for="text6">Blood Presure</label>
											<span class="mdl-textfield__error">Number required!</span>
										</div>
									</div>
									<div class="col-lg-12 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text"
												pattern="-?[0-9]*(\.[0-9]+)?" id="txtSugger">
											<label class="mdl-textfield__label" for="txtSugger">Sugger</label>
											<span class="mdl-textfield__error">Number required!</span>
										</div>
									</div>
									<div class="col-lg-12 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text" id="txtinjury">
											<label class="mdl-textfield__label" for="txtinjury">Injury/Condition</label>
										</div>
									</div>
		...
		<div class="page-footer">
			<div class="page-footer-inner"> 2021 &copy; RedStar Hospital Template By
				<a href="https://radixtouch.com/cdn-cgi/l/email-protection#582a3d3c2b2c392a2c303d353d183f35393134763b3735" target="_top" class="makerCss">Redstartheme</a>
			</div>
	...
	<script src="adminassets/data/getmdl-select.js"></script>
	<script src="adminassets/bundles/flatpicker/js/flatpicker.min.js"></script>
	<script src="adminassets/data/date-time.init.js"></script>

	<!-- dropzone -->
	<script src="adminassets/bundles/dropzone/dropzone.js"></script>
	<script src="adminassets/bundles/dropzone/dropzone-call.js"></script>
	<!-- end js include path -->
</body>
